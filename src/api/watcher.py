...
class HeadlessWatcher:
    def __init__(self, env_id, model_path, model_type="RPPO"):
        self.env_id = env_id
    ...
    def step(self):
        ...
        if done:
            ...
            self.total_reward = 0
            self.step_count = 0
            return global_frame, agent_view, action, reward, done, True, final_reward, steps
            
        return global_frame, agent_view, action, reward, done, False, 0, 0
